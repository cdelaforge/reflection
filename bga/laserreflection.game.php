    ...
    */
    ...
    function stGameInit() {
        if ($this->isModeSolo()) {
            ...
            //Vous commencez votre aventure avec un coeur, si vous échouez à résoudre une énigme vous le perdez, si vous échouez de nouveau la partie est perdue. Bonne chance !
