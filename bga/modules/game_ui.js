...
const gameUI = {
  ...
  doAdd: function () {
    ...
    if (!disp && !isIOSChrome && isChromium !== null && typeof isChromium !== "undefined" && vendorName === "Google Inc." && isOpera === false /*&& isIEedge === false*/) {
